...
read_globals = {
    ...
    "SecondsToTime", "MacroFrameText", "ChatFrame1EditBox", "strlenutf8", "AddonCompartmentFrame",
    ...
    "ChatEdit_UpdateHeader", "ChatEdit_ActivateChat", "ChatEdit_OnTextChanged",
    "ChatFrameUtil", "NUM_CHAT_WINDOWS", "STATICPOPUP_NUMDIALOGS",
