...
L["SNIPPET_KEYWORD_HINT"]               = "Typing \\keyword followed by a space in chat expands it into the snippet text."
L["SNIPPET_TEXT"]                       = "Text"
L["SNIPPET_FORMAT_NOTE"]                = "Formatting shows in notes; chat receives plain text. Placeholders: {date}, {time}, {player}, {target}, {zone}."
L["SNIPPET_INSERT_NOTE"]                = "Insert into note"
L["SNIPPET_DELETE_CONFIRM"]             = "Delete snippet \"%s\"?"
L["SNIPPET_EXPAND_IN_CHAT"]             = "Expand keywords in chat"
