...
L["TUT_SLIDE_SEARCH_INTRO"]             = "Search gear, panels, settings, collections, currencies, achievements, zones, and more. Note the {L:hl:altnum}Alt + num{/L} on the right of each row which indicates a shortcut to activate the row. You can hide the reminder in the search options."
