...
L["EFLINK_ROW_TT"]                      = "Send this result to a chat channel or a player as a link. Anyone with EasyFind can click it to open this exact result."
L["EFLINK_ROW_TT_NOTE"]                 = "Without EasyFind, they see it as plain text."
