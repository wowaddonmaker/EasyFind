...
local SNAP_FIELDS = {
    ...
    { "hierEntryPool",   "Database.hierEntryPool",   function() return ns.Database and ns.Database._hierEntryPool end },
    { "resultEntryPool", "Database.resultEntryPool", function() return ns.Database and ns.Database._resultEntryPool end },
    { "treeNodePool",    "Database.treeNodePool",    function() return ns.Database and ns.Database._treeNodePool end },
    ...
    { "PB",              "UI.PB",                    function() return ns.UI and ns.UI._PB end },
