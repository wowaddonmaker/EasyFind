...
local SEARCH_TEX_FILL = "Interface\\AddOns\\EasyFind-rares\\Textures\\SearchBarFill"
local SEARCH_TEX_BORDER = "Interface\\AddOns\\EasyFind-rares\\Textures\\SearchBarBorder"
