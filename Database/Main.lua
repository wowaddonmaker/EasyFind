            ...
            children = {
                {
                    ...
                    children = {
                        ...
                        { name = "Questing (Premade)", keywords = {"questing", "quest", "quest group", "quest lfg", "find quest group", "premade questing", "premade"}, steps = {{ waitForFrame = "PVEFrame", sideTabIndex = 3 }, { waitForFrame = "PVEFrame", lfgCategoryID = 1, text = L["GUIDE_PREMADE_QUESTING"] }} },
                        { name = "Delves (Premade)", keywords = {"delves", "delve group", "delve lfg", "find delve group", "premade delves", "delve", "premade"}, steps = {{ waitForFrame = "PVEFrame", sideTabIndex = 3 }, { waitForFrame = "PVEFrame", lfgCategoryID = 121, text = L["GUIDE_PREMADE_DELVES"] }} },
                        { name = "Dungeons (Premade)", keywords = {"dungeons", "dungeon group", "dungeon lfg", "find dungeon group", "premade dungeons", "m+ group", "mythic group", "premade"}, steps = {{ waitForFrame = "PVEFrame", sideTabIndex = 3 }, { waitForFrame = "PVEFrame", lfgCategoryID = 2, text = L["GUIDE_PREMADE_DUNGEONS"] }} },
                        { name = "Raids - The War Within (Premade)", keywords = {"raids", "raids the war within", "raid group", "raid lfg", "find raid group", "premade raids", "tww raid", "war within raid", "nerub-ar", "liberation of undermine", "premade"}, steps = {{ waitForFrame = "PVEFrame", sideTabIndex = 3 }, { waitForFrame = "PVEFrame", lfgCategoryID = 3, lfgFilters = (Enum and Enum.LFGListFilter and Enum.LFGListFilter.Recommended) or 0x1, text = L["GUIDE_PREMADE_RAIDS_TWW"] }} },
                        { name = "Raids - Legacy (Premade)", keywords = {"raids", "raids legacy", "legacy raid", "old raid", "legacy raid group", "legacy lfg", "transmog raid", "tmog raid", "mount run", "premade"}, steps = {{ waitForFrame = "PVEFrame", sideTabIndex = 3 }, { waitForFrame = "PVEFrame", lfgCategoryID = 3, lfgFilters = (Enum and Enum.LFGListFilter and Enum.LFGListFilter.NotRecommended) or 0x2, text = L["GUIDE_PREMADE_RAIDS_LEGACY"] }} },
                        { name = "Custom PvE Group", keywords = {"custom", "custom pve", "custom group", "custom lfg", "pve custom", "premade"}, steps = {{ waitForFrame = "PVEFrame", sideTabIndex = 3 }, { waitForFrame = "PVEFrame", lfgCategoryID = 6, text = L["GUIDE_PREMADE_CUSTOM_PVE"] }} },
                    },
                },

                {
                    ...
                    children = {
                        ...
                        { name = "Arenas (Premade)", keywords = {"arena premade", "arena group", "arena lfg", "find arena", "arena", "premade"}, category = "PvP", steps = {{ waitForFrame = "PVEFrame", pvpSideTabIndex = 3 }, { waitForFrame = "PVEFrame", lfgCategoryID = 4, text = L["GUIDE_PREMADE_ARENAS"] }} },
                        { name = "Arena Skirmishes (Premade)", keywords = {"arena skirmish premade", "skirmish group", "skirmish lfg", "skirmish", "premade"}, category = "PvP", steps = {{ waitForFrame = "PVEFrame", pvpSideTabIndex = 3 }, { waitForFrame = "PVEFrame", lfgCategoryID = 7, text = L["GUIDE_PREMADE_ARENA_SKIRMISHES"] }} },
                        { name = "Battlegrounds (Premade)", keywords = {"bg premade", "battleground group", "bg lfg", "find bg", "battleground", "premade"}, category = "PvP", steps = {{ waitForFrame = "PVEFrame", pvpSideTabIndex = 3 }, { waitForFrame = "PVEFrame", lfgCategoryID = 8, text = L["GUIDE_PREMADE_BATTLEGROUNDS"] }} },
                        { name = "Rated Battlegrounds (Premade)", keywords = {"rated bg premade", "rbg premade", "rbg group", "rbg lfg", "rated battleground", "premade"}, category = "PvP", steps = {{ waitForFrame = "PVEFrame", pvpSideTabIndex = 3 }, { waitForFrame = "PVEFrame", lfgCategoryID = 9, text = L["GUIDE_PREMADE_RATED_BG"] }} },
                        { name = "Custom PvP Group", keywords = {"custom pvp", "custom group", "custom lfg", "pvp custom", "custom", "premade"}, category = "PvP", steps = {{ waitForFrame = "PVEFrame", pvpSideTabIndex = 3 }, { waitForFrame = "PVEFrame", lfgCategoryID = 6, text = L["GUIDE_PREMADE_CUSTOM_PVP"] }} },
                        {
